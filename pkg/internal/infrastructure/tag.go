...
func gardenTag(garden string) model.Tag {
	return model.Tag{Scope: strptr(ScopeGarden), Tag: strptr(garden)}
}

func shootTag(shoot string) model.Tag {
	return model.Tag{Scope: strptr(ScopeShoot), Tag: strptr(shoot)}
}
