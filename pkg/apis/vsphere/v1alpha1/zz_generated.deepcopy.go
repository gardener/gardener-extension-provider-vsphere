...
func (in *CloudProfileConfig) DeepCopyInto(out *CloudProfileConfig) {
	*out = *in
	...
	if in.VsphereWithKubernetes != nil {
		in, out := &in.VsphereWithKubernetes, &out.VsphereWithKubernetes
		*out = new(VsphereWithKubernetes)
		(*in).DeepCopyInto(*out)
	}
	if in.Regions != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *K8sRegionSpec) DeepCopyInto(out *K8sRegionSpec) {
	*out = *in
	if in.Zones != nil {
		in, out := &in.Zones, &out.Zones
		*out = make([]K8sZoneSpec, len(*in))
		copy(*out, *in)
	}
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new K8sRegionSpec.
func (in *K8sRegionSpec) DeepCopy() *K8sRegionSpec {
	if in == nil {
		return nil
	}
	out := new(K8sRegionSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *K8sZoneSpec) DeepCopyInto(out *K8sZoneSpec) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new K8sZoneSpec.
func (in *K8sZoneSpec) DeepCopy() *K8sZoneSpec {
	if in == nil {
		return nil
	}
	out := new(K8sZoneSpec)
...
func (in *NSXTInfraState) DeepCopyInto(out *NSXTInfraState) {
	*out = *in
	...
	if in.ExternalTier1Gateway != nil {
		in, out := &in.ExternalTier1Gateway, &out.ExternalTier1Gateway
		*out = new(bool)
		**out = **in
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VsphereWithKubernetes) DeepCopyInto(out *VsphereWithKubernetes) {
	*out = *in
	if in.Namespace != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VsphereWithKubernetes.
func (in *VsphereWithKubernetes) DeepCopy() *VsphereWithKubernetes {
	if in == nil {
		return nil
	}
	out := new(VsphereWithKubernetes)
